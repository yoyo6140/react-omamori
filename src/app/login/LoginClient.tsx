    ...
    <div className="min-h-screen bg-[var(--off-white)] text-[var(--sumi-black)]">
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden lg:block overflow-hidden">
          ...
          <div className="relative h-full p-16 flex flex-col pt-40">
            <div className="space-y-3 text-center">
              <img
                src={logo.src}
                alt="御守之緣"
                className="mx-auto mb-6 h-56 w-80 opacity-90 bg-transparent"
              />
            ...
            <div className="rounded-2xl bg-white shadow-sm border border-black/5 p-7 sm:p-9">
              ...
              <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <div className="flex items-center justify-end">
                  <button
                    type="button"
                    className="text-sm text-gray-500 hover:text-[var(--torii-red)] cursor-pointer"
              ...
              <ErrorModal
                open={isForgotOpen}
                title="聯絡管理者"
                description="請聯絡管理者重置密碼。"
                onClose={() => setIsForgotOpen(false)}
              />

              <div className="mt-7 pt-6 border-t border-black/5 flex items-center justify-end text-sm">
                <Link href="/home" className="text-[var(--torii-red)] hover:underline underline-offset-4">
                  回到首頁
                </Link>
              </div>
            </div>
